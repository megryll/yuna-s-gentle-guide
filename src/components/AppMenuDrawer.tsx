      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-5 pb-6 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          ...
          <div className="mt-8 rounded-2xl hairline overflow-hidden bg-background">
            ...
            <button
              onClick={() => onOpenChange(false)}
              className="w-full flex items-center gap-3 px-4 py-3 text-left text-alert-red hover:bg-alert-red/[0.06] active:bg-alert-red/10 transition-colors border-t border-border"
            >
