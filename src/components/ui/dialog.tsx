...
const DialogPortal = ({
  ...
  return (
    <DialogPrimitive.Portal container={container ?? phoneContainer ?? undefined} {...props} />
  );
};
    ...
    <DialogPrimitive.Overlay
      ...
      className={cn(
        (inFrame ? "absolute" : "fixed") +
          " inset-0 z-50 bg-foreground/40 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
        className,
      )}
      {...props}
    />
