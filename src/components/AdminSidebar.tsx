...
const PAGES: Entry[] = [
  ...
  { label: "Credentials", to: "/intro", search: { step: 1 }, sub: true },
  { label: "Ratings", to: "/intro", search: { step: 2 }, sub: true },
  { label: "Mood data", to: "/intro", search: { step: 3 }, sub: true },
  { label: "Privacy", to: "/intro", search: { step: 4 }, sub: true },
  { label: "Voice", to: "/intro", search: { step: 5 }, sub: true },
