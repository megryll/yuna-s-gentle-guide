...
export const PAGES: ScreenEntry[] = [
  ...
  { label: "Tools", to: "/tools" },
  {
    ...
    children: [
      { label: "Survey · What matters", to: "/therapist-preferences", search: { step: 0 } },
      { label: "Survey · What to avoid", to: "/therapist-preferences", search: { step: 1 } },
      { label: "Survey · Quick ones", to: "/therapist-preferences", search: { step: 2 } },
      ...
      { label: "Share Summary", to: "/therapist-share-summary/$id", params: { id: "kerstin" } },
      {
        ...
        to: "/chat",
        search: { guided: "Session debrief", flow: "therapist-debrief", therapist: "kerstin" },
      },
    ],
  },
  {
