...
**Status:** Phase 1–2 (foundations) **done**; token/codebase cleanup pass **done and committed** (`fbdbb05` on `main`, 2026-06-29). **Phase 3 — all 27 in-scope primitives drawn (2026-06-30) AND the composite instancing rework is COMPLETE (2026-06-30).** (Icons page intentionally OUT of scope per user.) The library is now real: composites reference DS component instances, not inline copies. Remaining: optional Phase 4 QA + the parity gaps flagged at the bottom of the rework section.
